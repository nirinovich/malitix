  ...
  return (
    <div className="relative inline-block w-full sm:w-auto">
      <button
        ...
        className={`group relative w-full sm:w-auto px-6 sm:px-10 lg:px-12 py-4 sm:py-5 lg:py-6 text-base sm:text-lg lg:text-xl font-bold rounded-xl transition-all duration-300 bg-[var(--brand-primary)] hover:bg-[#1e7a8f] text-white ${isHovered ? "shadow-2xl" : "shadow-lg"}`}
      >
        ...
        <div
          className={`absolute inset-0 rounded-xl border-2 transition-all duration-300 ${
            isHovered ? "border-white/50 scale-105" : "border-white/20 scale-100"
          }`}
        ></div>
      </button>
    </div>
