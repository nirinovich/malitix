      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-[var(--text-primary)]">
            4 Piliers Pour Votre <span className="text-[var(--brand-text)]">Succès</span>
          </h2>
        </div>
          ...
          {simplifiedStack.map((item, index) => {
            ...
            return (
              <div key={index} className="text-center space-y-4">
                <div className="mx-auto w-20 h-20 rounded-2xl flex items-center justify-center bg-[var(--brand-primary)]/10 border-2 border-[var(--brand-primary)]/30">
                  <Icon className="text-[var(--brand-primary)]" size={36} />
                </div>
        ...
        <div className="mt-16 p-8 rounded-3xl text-center bg-gradient-to-r from-[var(--brand-primary)]/10 to-[var(--brand-primary)]/5 border border-[var(--brand-primary)]/20">
