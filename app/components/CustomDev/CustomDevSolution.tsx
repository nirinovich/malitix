...
const solutions = [
  {
    ...
    description:
      "Nous concevons des systèmes (Web & Mobile) capables de passer de 100 à 1 million d'utilisateurs sans s'écrouler.",
    features: [
  ...
  },
  {
    ...
    description:
      "Vos équipes vont aimer utiliser l'outil. Fini la formation de 3 semaines pour comprendre l'interface.",
    features: ["Design centré utilisateur", "Interfaces épurées", "Tests utilisateurs"],
  },
  {
    icon: Key,
    title: "Propriété Totale (IP)",
    description:
      "Arrêtez de louer votre outil de travail. Le code vous appartient. C'est un actif valorisable de votre entreprise.",
    features: ["100% propriétaire du code", "Aucune dépendance", "Valeur patrimoniale"],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-4">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[var(--text-primary)]">
            ...
            Nous Construisons Votre <span className="text-[var(--brand-primary)]">Actif Numérique</span>
          </h2>

          <p className="text-lg sm:text-xl text-[var(--text-secondary)]">
            Nous ne sommes pas juste des "codeurs". Nous sommes des architectes de solutions
            business.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
          {solutions.map((solution, index) => {
            ...
            return (
              <div
                key={index}
                className="group backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 border transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl bg-gradient-to-br from-[var(--brand-primary)]/10 to-[var(--brand-primary)]/5 border-[var(--brand-primary)]/20 hover:border-[var(--brand-primary)]/40"
              >
                <div className="mb-6 text-[var(--brand-primary)] group-hover:scale-110 transition-transform duration-300 inline-block">
                  <Icon size={40} />
                </div>
                ...
                <ul className="space-y-3">
                  {solution.features.map((feature, i) => (
                    <li
                      key={i}
                      className="text-sm flex items-center gap-2 text-[var(--text-tertiary)]"
                    >
