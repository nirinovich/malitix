...
const testimonials = [
  {
    ...
    quote:
      "L'application développée par Malitix nous a fait gagner 2h par jour par chauffeur. ROI atteint en 4 mois.",
    rating: 5,
  ...
  },
  {
    ...
    quote:
      "Nous avons pu lancer notre MVP en 8 semaines et lever des fonds grâce à la robustesse de la solution.",
    rating: 5,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-4">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[var(--text-primary)]">
            ...
            <span className="text-[var(--brand-text)]">Cartonnent</span>
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="group backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 border transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl bg-gradient-to-br from-[var(--surface-primary)] to-[var(--surface-primary)] border-[var(--brand-primary)]/20 hover:border-[var(--brand-primary)]/40"
            >
              <Quote className="mb-4 text-[var(--brand-primary)]/40" size={32} />
              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                ...
                <div className="px-4 py-2 rounded-full text-sm font-bold bg-[var(--brand-primary)]/20 text-[var(--brand-primary)]">
                  {testimonial.result}
                </div>
              </div>
            </div>
