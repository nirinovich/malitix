...
export default function SprintBenefits() {
  return (
    <section className="py-16 sm:py-20 lg:py-24 relative overflow-hidden bg-gradient-to-b from-[var(--bg-secondary)] to-[var(--bg-primary)]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 mb-12 sm:mb-16 bg-gradient-to-br from-[var(--surface-primary)] to-[var(--bg-secondary)] border border-[var(--border-primary)]">
          <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-8 sm:mb-10 text-center text-[var(--text-primary)]">
