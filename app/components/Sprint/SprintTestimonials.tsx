      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-4">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold px-4 text-[var(--text-primary)]">
            ...
            <span className="text-[var(--brand-primary)]">Nous Avons Livré</span>
          </h2>
        ...
        >
          <div className="overflow-hidden min-h-[400px] flex justify-center items-center">
            ...
            >
              <div className="group relative backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-10 mx-4 transition-all duration-500 hover:shadow-2xl bg-gradient-to-br from-[var(--surface-primary)] to-[var(--surface-primary)] border border-[var(--border-primary)] hover:border-[var(--brand-primary)]/50 hover:shadow-[var(--brand-primary)]/20">
                {/* Quote icon */}
                ...
                <div className="flex gap-1 mb-6">
                  {[...Array(testimonials[activeIndex].rating)].map((_, i) => (
                    <Star key={i} size={18} className="text-[var(--brand-primary)] fill-[var(--brand-primary)]" />
                  ))}
                </div>
                ...
                <div className="flex items-center gap-4">
                  <img
                    ...
                    loading="lazy"
                    className="w-12 h-12 rounded-full object-cover border-2 border-[var(--brand-primary)]/20"
                  />
                  {/* Author Info */}
                  <div>
              ...
              {testimonials.map((_, idx) => (
                <button
                  ...
                  className={`h-2 rounded-full cursor-pointer transition-all duration-300 ${
                    activeIndex === idx ? "w-8 bg-[var(--brand-primary)]" : "w-2 bg-[var(--border-primary)]"
                  }`}
