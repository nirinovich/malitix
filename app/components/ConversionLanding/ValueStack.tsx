...
const items: ConversionLandingValueItem[] = [
  {
    ...
    description:
      "Pourquoi attendre 3 mois de préavis ? Nos devs push du code dès leur première semaine.",
  },
  {
    icon: BadgeCheck,
    title: "Expertise Tech Validée",
    description:
      "Nous ne vous envoyons pas des juniors. Nos ingénieurs ont livré plus de 600 projets complexes.",
  },
  {
    icon: Shuffle,
    title: "Flexibilité Totale",
    description:
      "Besoin de scaler pour un rush ? On ajoute 2 devs. Le rush est fini ? On réduit la voilure. Vous payez ce que vous consommez.",
  },
  {
    icon: Shield,
    title: "Zéro Risque RH",
    description:
      "Pas de charges patronales, pas de gestion de carrière, pas de drama. On gère l'humain, vous gérez la vision.",
  },
];
        ...
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-12 items-start">
          ...
          <div className="space-y-4">
            {items.map((item) => (
              ...
              >
                <div className="h-10 w-10 rounded-xl bg-[var(--brand-primary)]/15 flex items-center justify-center">
                  <item.icon className="text-[var(--brand-primary)]" size={20} aria-hidden="true" />
                </div>
                <div>
