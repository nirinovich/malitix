...
export function AboveTheFold() {
  ...
  return (
    <motion.section
      ref={sectionRef}
      id="above-the-fold"
      className={`pt-28 pb-20 overflow-hidden ${theme === "dark" ? "bg-[#060705]" : "bg-[#f5f7f9]"}`}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
          ...
          <div className="relative">
            <div
              className={`rounded-3xl border p-8 shadow-2xl transition-all duration-500 hover:-translate-y-1 ${
