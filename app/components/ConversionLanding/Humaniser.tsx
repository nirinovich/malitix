...
export function Humaniser() {
  const { paragraph, title, subtitle, imageAlt, imageCaptionTitle, imageCaptionSubtitle, callout } =
        ...
        <div className="rounded-3xl overflow-hidden border border-[var(--border-primary)]">
          <div className="grid lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="p-10 bg-[var(--surface-primary)]">
              <div className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.2em] text-[var(--brand-primary)]">
                <UsersRound size={16} />
                {subtitle}
              </div>
              ...
              <div className="mt-6 rounded-2xl p-4 border border-[var(--border-primary)] bg-[var(--surface-elevated)] text-[var(--text-secondary)]">
                {callout}
              </div>
            </div>
          </div>
