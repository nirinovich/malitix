  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-br from-[var(--brand-primary)]/12 to-[#1e7a8f]/12 border border-[var(--brand-primary)]/40 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg">
          {submissionStatus === "success" ? (
            <div className="text-center py-8 sm:py-10 space-y-3 sm:space-y-4 animate-in zoom-in">
              <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-[var(--brand-primary)]/15 rounded-full">
                <CheckCircle2 className="text-[var(--brand-primary)]" size={32} />
              </div>
              <div>
            ...
            <>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 sm:space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-[var(--brand-primary)] hover:bg-[#1e7a8f] disabled:bg-[var(--brand-primary)]/50 text-white font-bold py-4 rounded-lg transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-[var(--brand-primary)]/20 flex items-center justify-center gap-2 cursor-pointer"
                >
                  {isSubmitting ? (
                    <>
                ...
                <p className="text-xs text-center text-[var(--text-muted)] mt-4">
                  En cliquant, vous acceptez d'être recontacté pour votre projet. Vos données
