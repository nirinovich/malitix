          ...
          <div className="space-y-4 sm:space-y-6">
            <div>
              ...
              <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-[var(--brand-primary)] mt-3 sm:mt-4">
                Construisez une application que vous possédez vraiment. Rapide. Sécurisée. Et prête
                pour la guerre.
              </h2>
            </div>
            <p className="text-base sm:text-lg text-[var(--text-secondary)] leading-relaxed">
              Une équipe complète de spécialistes mobiles. Pas de freelance débordé. Pas d'outils
              automatiques fragiles.
            </p>
            <div className="space-y-2 sm:space-y-3">
              <div className="flex items-center gap-2 sm:gap-3">
                <CheckCircle2 className="text-[var(--brand-primary)] flex-shrink-0" size={20} />
                <span className="text-sm sm:text-base text-[var(--text-primary)]">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <CheckCircle2 className="text-[var(--brand-primary)] flex-shrink-0" size={20} />
                <span className="text-sm sm:text-base text-[var(--text-primary)]">
                  Sécurisé (DORA/RGAA compliant)
                </span>
              </div>
            </div>
            <button className="mt-6 sm:mt-8 px-6 sm:px-8 py-3 sm:py-4 bg-[var(--brand-primary)] hover:bg-[#1e7a8f] text-white text-sm sm:text-base font-bold rounded-lg transition-all w-full sm:w-auto">
    ...
    <div className="relative h-[300px] sm:h-[380px] md:h-[460px] lg:h-[520px] flex items-center justify-center p-2 sm:p-4 overflow-visible">
      ...
      >
        ...
        <g>
          ...
          {/* Wheels */}
          <circle cx="95" cy="335" r="8" fill="var(--brand-primary)" />
          <circle cx="165" cy="335" r="8" fill="var(--brand-primary)" />
        ...
        <g className={armClass} style={isAnimating ? { willChange: "transform" } : undefined}>
          {/* Arm */}
          <rect x="110" y="120" width="20" height="160" fill="var(--brand-primary)" rx="10" />
          {/* Cup */}
          <circle cx="120" cy="110" r="18" fill="#3bb8d4" />
          <circle cx="120" cy="110" r="14" fill="var(--brand-primary)" />
        </g>
        ...
        <g
          ...
          style={
            isAnimating
              ? { transformOrigin: "120px 110px", willChange: "transform, opacity" }
        ...
        >
          ...
          {/* Phone Screen */}
          <rect x="105" y="85" width="30" height="50" fill="var(--brand-primary)" rx="3" />
        ...
        <g className={targetClass}>
          ...
          <circle
            ...
            opacity="0.5"
          />
          <line x1="400" y1="130" x2="390" y2="130" stroke="var(--brand-primary)" strokeWidth="1.5" />
          <line x1="410" y1="130" x2="420" y2="130" stroke="var(--brand-primary)" strokeWidth="1.5" />
          <line x1="405" y1="125" x2="405" y2="115" stroke="var(--brand-primary)" strokeWidth="1.5" />
          <line x1="405" y1="135" x2="405" y2="145" stroke="var(--brand-primary)" strokeWidth="1.5" />
        </g>
