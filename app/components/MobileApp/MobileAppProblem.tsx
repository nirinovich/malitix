...
const MobileAppProblem: React.FC = React.memo(() => {
  return (
    <section className="py-16 md:py-24 bg-[var(--bg-primary)] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 right-0 w-96 h-96 bg-[var(--brand-primary)] opacity-5 rounded-full blur-3xl -translate-y-1/2"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[var(--text-primary)] mb-4 sm:mb-6 px-2">
            Il y a deux façons de créer une app.
          </h2>
          <div className="mt-3 sm:mt-3 text-center px-4">
            <p className="text-xl sm:text-2xl font-bold text-[var(--text-secondary)]">
              Nous ne faisons que la façon{" "}
              <span className="text-[var(--brand-primary)] border-b-2 sm:border-b-4 border-[var(--brand-primary)] pb-1">
                "Solide"
              </span>
              .
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-6 items-center">
          ...
          <div className="lg:col-span-2 bg-gradient-to-br from-red-500/15 to-red-600/15 border-2 border-red-400/50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 relative overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="relative z-10">
              ...
              <p className="text-[var(--text-primary)] text-sm sm:text-base leading-relaxed mb-6 sm:mb-8 font-medium">
                Le Piège classique : vous payez peu mais obtenez peu. Vous n'êtes jamais
                propriétaire.
              </p>
              <div className="grid grid-cols-1 gap-4 sm:gap-5 mb-6 sm:mb-8">
                <div className="flex items-start gap-3 group">
                  ...
                  <p className="text-[var(--text-primary)] text-sm leading-relaxed">
                    Freelance isolé ou outil automatique
                  </p>
                </div>
                <div className="flex items-start gap-3 group">
                  <div className="w-3 h-3 rounded-full bg-gradient-to-br from-red-500 to-red-600 mt-1.5 group-hover:scale-125 transition-transform flex-shrink-0"></div>
                  <p className="text-[var(--text-primary)] text-sm leading-relaxed">
                    Rapide au début seulement
                  </p>
                </div>
                <div className="flex items-start gap-3 group">
                  <div className="w-3 h-3 rounded-full bg-gradient-to-br from-red-500 to-red-600 mt-1.5 group-hover:scale-125 transition-transform flex-shrink-0"></div>
                ...
                <div className="flex items-start gap-3 group">
                  <div className="w-3 h-3 rounded-full bg-gradient-to-br from-red-500 to-red-600 mt-1.5 group-hover:scale-125 transition-transform flex-shrink-0"></div>
                  <p className="text-[var(--text-primary)] text-sm leading-relaxed">
                    Ça rame avec beaucoup d'utilisateurs
                  </p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-6 pt-6 sm:pt-8 border-t border-red-400/20">
                <div className="text-center">
                  ...
                  <div className="text-xs sm:text-sm text-[var(--text-secondary)] font-semibold mt-2">
          ...
          <div className="lg:col-span-2 bg-gradient-to-br from-[var(--brand-primary)]/15 to-[#1e7a8f]/15 border-2 border-[var(--brand-primary)]/50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 relative overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="absolute -left-12 -top-12 w-32 h-32 sm:w-40 sm:h-40 bg-[var(--brand-primary)] opacity-5 rounded-full blur-2xl"></div>
            <div className="relative z-10">
              <div className="flex items-start gap-3 sm:gap-4 mb-5 sm:mb-6">
                <div className="bg-gradient-to-br from-[var(--brand-primary)] to-[#1e7a8f] rounded-lg p-3 flex-shrink-0">
                  <span className="text-white text-2xl font-bold">✓</span>
                </div>
                <div>
                  <h3 className="text-2xl sm:text-3xl font-bold text-[var(--brand-primary)]">
                    La façon "Solide"
                  </h3>
                  <p className="text-xs text-[var(--brand-primary)] font-bold uppercase tracking-widest mt-1">
                    La Méthode
                  </p>
                </div>
              </div>
              <p className="text-[var(--text-primary)] text-sm sm:text-base leading-relaxed mb-6 sm:mb-8 font-medium">
                Ce que font les géants du monde. Vous gardez tout le contrôle et la performance.
              </p>
              <div className="grid grid-cols-1 gap-4 sm:gap-5 mb-6 sm:mb-8">
                <div className="flex items-start gap-3 group">
                  <div className="w-3 h-3 rounded-full bg-gradient-to-br from-[var(--brand-primary)] to-[#1e7a8f] mt-1.5 group-hover:scale-125 transition-transform flex-shrink-0"></div>
                  <p className="text-[var(--text-primary)] text-sm leading-relaxed">
                    Propriétaire du code à 100%
                  </p>
                </div>
                <div className="flex items-start gap-3 group">
                  <div className="w-3 h-3 rounded-full bg-gradient-to-br from-[var(--brand-primary)] to-[#1e7a8f] mt-1.5 group-hover:scale-125 transition-transform flex-shrink-0"></div>
                  <p className="text-[var(--text-primary)] text-sm leading-relaxed">
                    Rapide, même avec des millions d'utilisateurs
                  </p>
                </div>
                <div className="flex items-start gap-3 group">
                  <div className="w-3 h-3 rounded-full bg-gradient-to-br from-[var(--brand-primary)] to-[#1e7a8f] mt-1.5 group-hover:scale-125 transition-transform flex-shrink-0"></div>
                  <p className="text-[var(--text-primary)] text-sm leading-relaxed">
                    Sécurisé (aucun pirate ne passe)
                  </p>
                </div>
                <div className="flex items-start gap-3 group">
                  <div className="w-3 h-3 rounded-full bg-gradient-to-br from-[var(--brand-primary)] to-[#1e7a8f] mt-1.5 group-hover:scale-125 transition-transform flex-shrink-0"></div>
                  <p className="text-[var(--text-primary)] text-sm leading-relaxed">
                    Interface fluide (React Native / Natif)
                  </p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-6 pt-6 sm:pt-8 border-t border-[var(--brand-primary)]/20">
                <div className="text-center">
                  <div className="text-3xl sm:text-4xl font-black text-[var(--brand-primary)]">99%</div>
                  <div className="text-xs sm:text-sm text-[var(--text-secondary)] font-semibold mt-2">
                    Succès du projet
                  </div>
                </div>
                <div className="text-center">
                  <div className="text-3xl sm:text-4xl font-black text-[var(--brand-primary)]">100%</div>
                  <div className="text-xs sm:text-sm text-[var(--text-secondary)] font-semibold mt-2">
                    Vous êtes le chef
                  </div>
                </div>
