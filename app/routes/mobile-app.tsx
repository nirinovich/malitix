...
export const meta: Route.MetaFunction = () =>
  buildMeta({
    ...
    description:
      "Expert en développement mobile pour iOS, Android et cross-platform. Solutions natives et React Native, 50+ applications lancées avec une note de 4.8★. Du concept à l'App Store.",
