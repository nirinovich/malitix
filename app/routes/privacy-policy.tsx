...
export const meta: Route.MetaFunction = () => [
  ...buildMeta({
    ...
    description:
      "Politique de confidentialité et protection des données personnelles chez Malitix. Conformité RGPD et législation malgache sur la protection des données.",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 text-[var(--text-secondary)]">
            ...
            <section>
              ...
              <p>
                Vos données personnelles sont destinées aux services internes de Malitix. Elles
                peuvent également être transmises à nos sous-traitants (hébergement, outils de
                gestion, services marketing) qui s'engagent à respecter la confidentialité et la
                sécurité de vos données.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-bold mb-4 text-[var(--text-primary)]">7. Vos droits</h2>
            ...
            <section>
              ...
              <p>
                ...
                garantir la sécurité de vos données personnelles et les protéger contre tout accès
                non autorisé, modification, divulgation ou destruction.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-bold mb-4 text-[var(--text-primary)]">9. Cookies</h2>
              <p>
                Notre site utilise des cookies pour améliorer votre expérience de navigation. Vous
                pouvez configurer votre navigateur pour refuser les cookies ou être informé de leur
                utilisation. Certaines fonctionnalités du site peuvent être limitées sans cookies.
              </p>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-[var(--text-primary)]">11. Contact</h2>
              <p>
