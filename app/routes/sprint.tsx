...
export const meta: Route.MetaFunction = () =>
  buildMeta({
    ...
    description:
      "Vos projets IT sont en retard ? On redresse votre roadmap en 2 semaines. Diagnostic en 48h, équipe dédiée, résultats mesurables. 600+ projets livrés par 350+ ingénieurs.",
