      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`space-y-8 ${
          ...
          <section>
            ...
            <p className="mt-4">
              Pour exercer ces droits, contactez-nous à : <a href="mailto:contact@malitix.com" className="text-[#2ca3bd] hover:underline">contact@malitix.com</a>
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-none space-y-2 ml-4 mt-4">
              <li><strong>Email :</strong> <a href="mailto:contact@malitix.com" className="text-[#2ca3bd] hover:underline">contact@malitix.com</a></li>
