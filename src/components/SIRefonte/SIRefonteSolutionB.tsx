    ...
    <section id="solution-sirefonte" className={`relative py-24 overflow-hidden ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          {/* Connecting line on desktop - properly centered through step circles */}
          <div className="hidden lg:block absolute top-[3rem] left-[12%] right-[12%] h-0.5 bg-gradient-to-r from-[#2ca3bd] via-[#2ca3bd] to-[#2ca3bd] z-0"></div>
