import { FileSpreadsheet, Lock, Link2, AlertCircle } from 'lucide-react';
  ...
  return (
    <section className={`py-16 sm:py-20 lg:py-24 relative overflow-hidden ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Consequence - Emphasized Message */}
        <div className={`max-w-4xl mx-auto backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-10 border ${
          theme === 'dark'
          ...
          <div className="flex items-start gap-4 sm:gap-6">
            <div className={`p-3 rounded-xl ${
              ...
              <AlertCircle className="text-[#2ca3bd]" size={32} />
            </div>
            <div className="space-y-3">
              ...
              <p className={`text-base sm:text-lg leading-relaxed ${
                ...
                Vous perdez du temps, de l'argent, et votre avantage concurrentiel s'effrite. 
                Vous avez besoin d'une solution qui s'adapte à{' '}
                <span className={`font-bold ${theme === 'dark' ? 'text-[#2ca3bd]' : 'text-blue-600'}`}>
                  VOUS
                </span>
                , pas l'inverse.
              </p>
